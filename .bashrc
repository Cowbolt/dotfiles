...
alias gcc='gcc -Wall'
alias r='ranger'
alias unc='unclutter -idle 3 -jitter 50 &'

#skip to Examples
alias manx='man --pager="less -p ^EXAMPLES"'

#PATH
export PATH=/usr/local/bin:/usr/local/sbin:/usr/bin:/opt/android-sdk/tools:/opt/android-sdk/tools/bin:/usr/lib/jvm/default/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/home/aslak/.local/bin
...
## END OF FILE #################################################################
PATH="$PATH:/home/aslak/.conscript/bin"
